 ...
 */
//mcmonkey//BUGTRAP_API BOOL APIENTRY BT_SaveSnapshot(PCTSTR pszFileName);
/**
 * @brief Take a snapshot of program memory and save it to a file.
 */
//mcmonkey//BUGTRAP_API BOOL APIENTRY BT_SaveSnapshotEx(PEXCEPTION_POINTERS pExceptionPointers, PCTSTR pszFileName);
/**
